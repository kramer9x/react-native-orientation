package main.java.com.github.yamill.orientation;
 ...
 *
 * define 3 sensors as member variables Sensor accelerometer; Sensor
 * magnetometer; Sensor vectorSensor; DeviceOrientation deviceOrientation;
 *
 * add this to the activity's onCreate mSensorManager = (SensorManager)
 * getSystemService(SENSOR_SERVICE); accelerometer =
 * mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER); magnetometer =
 ...
 *
 *
 * then, you can simply call * deviceOrientation.getOrientation() * wherever you
 * want
 *
 *
...
public class DeviceOrientation {
    private final int ORIENTATION_PORTRAIT = Configuration.ORIENTATION_PORTRAIT;
    private final int ORIENTATION_LANDSCAPE_REVERSE = Configuration.ORIENTATION_LANDSCAPE;
    private final int ORIENTATION_LANDSCAPE = Configuration.ORIENTATION_LANDSCAPE;
    private final int ORIENTATION_PORTRAIT_REVERSE = Configuration.ORIENTATION_PORTRAIT;
